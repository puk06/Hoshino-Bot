...
class Tools {
    ...
    static rankconverter(rank) {
        switch (rank) {
            case "F":
                return "<:rankingF:1198529872440606720>";
            case "D":
                return "<:rankingD:1198529862261022791>";
            case "C":
                return "<:rankingC:1198529858603597865>";
            case "B":
                return "<:rankingB:1198529855260729444>";
            case "A":
                return "<:rankingA:1198529852517650442>";
            case "S":
                return "<:rankingS:1198529875892506645>";
            case "X":
                return "<:rankingX:1198529870364418068>";
            case "SH":
                return "<:rankingSH:1198529865691959346>";
            case "XH":
                return "<:rankingXH:1198529867508097174>";
            default:
                return "";
        }
    }
